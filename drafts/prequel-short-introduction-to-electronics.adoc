...
The table below shows the atomic model of silicon a semiconductor and copper conductor. Whit its four electrons on the valence band silicon is 
...
[width="100%" cols="a,a"]
|=====
| atomic model of a semiconductor | atomic model of a conductor
| image:../images/electronic_basics/atomic_model_Si.svg[width="250px"]
| image:../images/electronic_basics/atomic_model_Cu.svg[width="250px"]
|=====
