...
image:../images/how_does_cpu/xor_symbol.svg[width=800]
...
The author selected a simple example found in a 
...
These are circuits which make use of feedback.
...
["latex","../images/half-adder.svg",imgfmt="svg", width="80%"]
\small
\[
\begin{array}{c}
c = x \land y \\
