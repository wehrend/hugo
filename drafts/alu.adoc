.. title: How does a CPU work? The swiss knife
...
Until now the author did not discuss an important
element, necessary in various places of the ALU.
The Multiplexer and demultiplexer, simple said those
are select switches. The task of a multiplexer is to select
one line.
