...
BLOG_AUTHOR = "Sven Wehrend"  # (translatable)
BLOG_TITLE = "Interdependent"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://wehrend.uber.space/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://svenwehrend.com/"
BLOG_EMAIL = "sven.wehrend@gmail.com"
BLOG_DESCRIPTION = "Thoughts of a carbon-based lifeform"  # (translatable)
