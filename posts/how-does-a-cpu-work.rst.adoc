...
image:../images/how_does_cpu/lights.png[width=100% title="A schematic of the imaginary circuit."]
...
image:../images/how_does_cpu/example.jpg[width=100% title="showing the binary value 9 (unsigned w/ MSB left)."]
...
image::../images/how_does_cpu/digitcircle.svg[wisth=100% title="Unit circle with numbering"]
